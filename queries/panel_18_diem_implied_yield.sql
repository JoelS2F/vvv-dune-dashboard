...
-- DIEM token: 0xf4d97f2da56e8c3098f3a8d538db636a2606a024
...
WITH diem_trades AS (
    SELECT
        ...
        CASE
            WHEN token_bought_address = 0xf4d97f2da56e8c3098f3a8d538db636a2606a024
                THEN amount_usd / NULLIF(token_bought_amount, 0)
            WHEN token_sold_address = 0xf4d97f2da56e8c3098f3a8d538db636a2606a024
